        ...
        try {
            ...
            if (!user) {
                Alert.alert(
                    ...
                    "Você precisa estar logado para visualizar eventos."
                );
                router.replace("/");
                return;
            }
            ...
            // Highlight // Definir depois os eventos que estiverem com data mais próxima
        ...
        return (
            ...
            >
                ...
                <View style={styles.eventContent}>
                    ...
                    <Text style={styles.eventDate}>🗓️ {eventDate}</Text>
