      ...
      {isEditing ? (
        <View style={{ gap: 16 }}>
          ...
          <Button
            ...
            variant="outline"
            onPress={() =>
              setShowPicker((prev) => ({ ...prev, date: !prev.date }))
            }
          />
          {showPicker.date && (
            <DateTimePicker
              ...
              onChange={(_, selectedDate) => {
                if (selectedDate) {
                  setEditedEvent((prev) => ({ ...prev, data: selectedDate }));
                }
          ...
          <Button
            ...
            variant="outline"
            onPress={() =>
              setShowPicker((prev) => ({ ...prev, time: !prev.time }))
            }
          />
          {showPicker.time && (
            <DateTimePicker
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setEditedEvent((prev) => ({ ...prev, capacity: text }))
            }
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setEditedEvent((prev) => ({ ...prev, ticket_price: text }))
            }
        ...
        <>
          <View style={styles.box}>
            ...
            <Text style={styles.date}>🎟️ Capacidade: {event.capacity}</Text>
            <Text style={styles.date}>
              💰 Preço: R$ {Number(event.ticket_price || 0).toFixed(2)}
            </Text>
            <Text style={styles.date}>
              🔄 Status:{" "}
            ...
            <Text style={styles.date}>
              ✅ Vendidos: {event.sold_count || 0} / {event.capacity || 0}
            </Text>
            <Text style={styles.date}>
              💵 Receita Estimada: R${" "}
