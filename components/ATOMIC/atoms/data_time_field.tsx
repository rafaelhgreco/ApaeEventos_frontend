...
const DateTimeField: React.FC<Props> = ({ value, mode, onChange, label, isVisible, onToggle }) => {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <TouchableOpacity activeOpacity={0.7} style={styles.dateField} onPress={() => onToggle(true)}>
        {mode === 'date' ? (
